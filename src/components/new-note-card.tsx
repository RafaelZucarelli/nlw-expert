...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  //váriavel boolean e uma função para atualizar o valor dela
  ...
  function handleStartRecording() {
    {
      /*  A API DE RECONHECIMENTO DE FALA ESTÁ DISPONÍVEL DENTRO DO NAVEGADOR? */
    }
  ...
  return (
    <Dialog.Root>
      {/* Este é o gatilho que abre o diálogo quando clicado */}
